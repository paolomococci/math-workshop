...
#ifndef LIBCHISQUARETEST_H
#define LIBCHISQUARETEST_H
...
void InsertPhi(long double *, char *);
...
void InsertPhi(long double *phi, char *response) {
    snprintf(response, 11, "%f", (double) (*phi));
}
